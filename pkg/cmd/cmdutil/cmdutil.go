...
func getHandlerPairs(cmd *cobra.Command, config cfg.Config) []handlerPair {
	...
	handlerPairs := []handlerPair{
		...
		{path: "/proxy", handler: handlers.ListRoutesHandler},
		{path: server.ProxyPath, handler: handlers.ListRoutesHandler},
		{path: server.ProxyPath + "/latest", handler: handlers.ListRoutesHandler},
